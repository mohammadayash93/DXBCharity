                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group {{ $errors->has('app_name_abv') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" name="app_name_abv" class="form-control"  maxlength="10" value="{{$config->app_name_abv}}">
                            ...
                            <div class="col-lg-1">
                                ...
                                <br>
                                <img src="{{ asset($config->app_logo) }}" width="30px" class="img-thumbnail">
                                <br><br>
                            </div>
                            <div class="col-lg-3">
