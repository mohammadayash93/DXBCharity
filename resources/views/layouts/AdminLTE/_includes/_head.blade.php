...
<link href="{{  asset('assets/adminlte/bower_components/summernote/css/summernote.min.css') }}" rel="stylesheet">
<script src="{{ asset('assets/adminlte/bower_components/summernote/js/summernote.min.js') }}"></script>
<style>
